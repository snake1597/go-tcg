...
This project is indexed by GitNexus as **go-tcg** (1368 symbols, 2794 relationships, 32 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
