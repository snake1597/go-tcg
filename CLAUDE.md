...
Prefix the feature-slug filename with the date in YYYYMMDD format.
...
This project is indexed by GitNexus as **go-tcg** (3267 symbols, 10990 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
