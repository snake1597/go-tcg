...
This project is indexed by GitNexus as **go-tcg** (1769 symbols, 4347 relationships, 80 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
